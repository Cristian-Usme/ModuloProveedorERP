...
export const proveedorService = {
  ...
  calificar:      (id, data) => api.post(`/proveedores/${id}/calificacion`, data).then((r) => r.data),
  miCalificacion: (id)     => api.get(`/proveedores/${id}/calificacion/mi-calificacion`).then((r) => r.data),
}
